...
@section('title', 'GymBook | Dashboard')
@section('content')
    <div id="main">
    <div class="row">
                                ...
                                <div id="messages" class="col s12 pb-0">
                                    <div class="collection border-none mb-0">
                                        ...
                                        <ul class="collection right-sidebar-chat p-0 mb-0">
                                            ...
                                            <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                                                    <span class="avatar-status avatar-online avatar-50"><img src="{{ asset('images/avatar/avatar-1.png') }}" alt="avatar" />
                                                        <i></i>
                                                    </span>
                                                <div class="user-content">
                                            ...
                                            <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                                                    <span class="avatar-status avatar-off avatar-50"><img src="{{ asset('images/avatar/avatar-2.png') }}" alt="avatar" />
                                                        <i></i>
                                                    </span>
                                                <div class="user-content">
                                            ...
                                            <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                                                    <span class="avatar-status avatar-online avatar-50"><img src="{{ asset('images/avatar/avatar-3.png') }}" alt="avatar" />
                                                        <i></i>
                                                    </span>
                                                <div class="user-content">
                                                    <h6 class="line-height-0">Caleb Richards</h6>
                                            ...
                                            <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                                                    <span class="avatar-status avatar-online avatar-50"><img src="{{ asset('images/avatar/avatar-4.png') }}" alt="avatar" />
                                                        <i></i>
                                                    </span>
                                                <div class="user-content">
                                            ...
                                            <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                                                    <span class="avatar-status avatar-off avatar-50"><img src="{{ asset('images/avatar/avatar-5.png') }}" alt="avatar" />
                                                        <i></i>
                                                    </span>
                                                <div class="user-content">
                                            ...
                                            <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                                                    <span class="avatar-status avatar-online avatar-50"><img src="{{ asset('images/avatar/avatar-6.png') }}" alt="avatar" />
                                                        <i></i>
                                                    </span>
                                                <div class="user-content">
                                            ...
                                            <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                                                    <span class="avatar-status avatar-off avatar-50"><img src="{{ asset('images/avatar/avatar-7.png') }}" alt="avatar" />
                                                        <i></i>
                                                    </span>
                                                <div class="user-content">
                                            ...
                                            <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                                                    <span class="avatar-status avatar-off avatar-50"><img src="{{ asset('images/avatar/avatar-8.png') }}" alt="avatar" />
                                                        <i></i>
                                                    </span>
                                                <div class="user-content">
                                            ...
                                            <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                                                    <span class="avatar-status avatar-online avatar-50"><img src="{{ asset('images/avatar/avatar-9.png') }}" alt="avatar" />
                                                        <i></i>
                                                    </span>
                                                <div class="user-content">
                                            ...
                                            <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                                                    <span class="avatar-status avatar-off avatar-50"><img src="{{ asset('images/avatar/avatar-10.png') }}" alt="avatar" />
                                                        <i></i>
                                                    </span>
                                                <div class="user-content">
                                            ...
                                            <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                                                    <span class="avatar-status avatar-off avatar-50"><img src="{{ asset('images/avatar/avatar-11.png') }}" alt="avatar" />
                                                        <i></i>
                                                    </span>
                                                <div class="user-content">
                                            ...
                                            <li class="collection-item right-sidebar-chat-item sidenav-trigger display-flex avatar pl-5 pb-0" data-target="slide-out-chat">
                                                    <span class="avatar-status avatar-online avatar-50"><img src="{{ asset('images/avatar/avatar-12.png') }}" alt="avatar" />
                                                        <i></i>
                                                    </span>
                                                <div class="user-content">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="carousel carousel-slider center intro-carousel">
                                        ...
                                        <div class="carousel-item slide-1">
                                            ...
                                            <h5 class="intro-step-title mt-7 center animated fadeInUp">Welcome to Gym Book</h5>
                                            <p class="intro-step-text mt-5 animated fadeInUp">
                                                Get Started in 3 steps:
                                            </p>
                                            <h6><i class="material-icons">check</i> Create your Gym</h6>
                                        </div>
                                        <div class="carousel-item slide-2">
                                            <img src="{{ asset('images/gallery/intro-features.png') }}" alt="" class="responsive-img slide-2-img">
                                            <h5 class="intro-step-title mt-7 center">Getting Started</h5>
                                            <h6><i class="material-icons">check</i> Create your Club Activities</h6>
                                            <h6><i class="material-icons">check</i> Create your Club Memberships</h6>
                                            <h6><i class="material-icons">check</i> Create your Club Subscriptions</h6>
                                        </div>
                                        <div class="carousel-item slide-3">
                                            <img src="{{ asset('images/gallery/intro-app.png') }}" alt="" class="responsive-img slide-1-img">
                                            <h5 class="intro-step-title mt-7 center">Getting Started</h5>
                                            <h6><i class="material-icons">check</i> Create Members</h6>
                                            <h6><i class="material-icons">check</i> Add Inquiries</h6>
                                            <h6><i class="material-icons">check</i> Manage Timelog</h6>
                                            <div class="row">
